...
public class NebulaConnectionConnectClickListener implements ControlledData {

    private NebulaConnectionData nebulaConnectionData;
    
    public NebulaConnectionConnectClickListener(NebulaConnectionData nebulaConnectionData) {
    ...
    public void mouseClicked(MouseEvent arg0) {
        this.nebulaConnectionData.connect();
    }
